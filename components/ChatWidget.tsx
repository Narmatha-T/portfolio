    ...
    <>
      ...
      <div className="fixed bottom-20 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
        ...
        <button
          ...
          className="pointer-events-auto group flex items-center gap-2 px-3 py-3 sm:px-4 bg-green-500 dark:bg-green-400 border border-green-500 dark:border-green-400 rounded-full text-white dark:text-zinc-900 hover:shadow-[0_0_20px_6px_rgba(34,197,94,0.6),0_0_40px_12px_rgba(34,197,94,0.25)] hover:scale-105 hover:brightness-95 transition-all duration-300 shadow-lg shadow-green-500/20 dark:shadow-green-400/20"
        >
